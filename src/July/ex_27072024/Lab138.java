...
public class Lab138 {
    public static void main(String[] args) {
        // Generally people don't prefer to use String in automation because Strings - immutable
        // in nature
        // We have two more classes i.e. 1. StringBuilder , 2. StringBuffer
        String s1 = "PRAMOD";
        s1 = "Dutta"; // In this 2 string obhect will be created in SCP memory
...
/** StringBuffer and StringBuilder is different based on thread safety and we avoid thread safety as
much as we can in automation because thread safety leads to slowness. So people use StringBuilder
most of the time **/