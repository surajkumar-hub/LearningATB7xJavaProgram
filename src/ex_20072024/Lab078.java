...
public class Lab078 {
    public static void main(String[] args) {
        // In web automation we have to select in which browser we have to run
        ...
        String browserName = sc.next(); // to take string we can use next()
        browserName = browserName.toLowerCase(); // this is required when user enters browser name
        // in upper case. This method will convert uppercase to lowercase
